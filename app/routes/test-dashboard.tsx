...
export default function TestDashboard() {
  ...
  return (
    <div className="min-h-screen bg-surface">
      {/* Dashboard Header — branded indigo */}
      <nav className="bg-brand-600">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 flex items-center justify-between" style={{ height: '56px' }}>
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-base font-bold text-white">Registerly</span>
          </div>
          <div className="flex items-center gap-4">
            <span className="text-sm text-indigo-200">{shop.domain}</span>
            <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-white/15 text-white">
              {shop.plan}
            </span>
          </div>
        </div>
